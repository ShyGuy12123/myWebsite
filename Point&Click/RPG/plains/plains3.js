document.addEventListener('DOMContentLoaded', async () => {
    ...
    const boostItem = document.getElementById('boost-item');
    ...
    function checkPlayerSequence() {
        ...
        if (playerSequence.length === puzzle.length) {
            ...
            boostItem.classList.remove('hidden');
            setButtonsDisabled(true);
        }
    }
    ...
    boostItem.addEventListener('click', () => {
        if (combinationCleared) {
            messageEl.textContent = "You obtained a new technology!";
        
            setTimeout(() => {
            window.location.href = "../rpg.html?location=plains&indoor=true&scripted=3";
            }, 3000);
